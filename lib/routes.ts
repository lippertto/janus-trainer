...
export const API_TRAININGS_YEARLY_TOTALS =
  '/api/trainings:calculate-yearly-totals';
export const API_TRAININGS_COUNT_PER_COURSE = '/api/trainings:count-per-course';
